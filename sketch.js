...
var bird, birdImg, duckImg;
var birdGroup, bird_collided;
...
function preload(){
  ...
  duckImg = loadAnimation("trex_ducking.png");
...
function setup() {
  ...
  trex.addAnimation("ducking", duckImg);
  trex.scale = 0.5;
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyWentDown(DOWN_ARROW)){
      trex.changeAnimation("ducking", duckImg);
    }
...
function spawnBirds(){
  if (frameCount % 60 === 0) {
    ...
    bird.addAnimation("birds", birdImg);
    bird.addAnimation("bird_collided", bird_collided);
    bird.scale = 0.5;
    bird.velocityX = -3;
